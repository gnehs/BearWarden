...
const en = {
  ...
  'attachment.uploadCardCoverTitle': 'Upload Card Face',
  'attachment.select': 'Select',
  'attachment.allFiles': 'All Files',
  'attachment.cardCoverImages': 'Card Face Images',
...
const zhCN: Record<MainMessageId, string> = {
  ...
  'attachment.uploadCardCoverTitle': '上传卡面',
  'attachment.select': '选择',
  'attachment.allFiles': '所有文件',
  'attachment.cardCoverImages': '卡面图片',
...
const zhTW: Record<MainMessageId, string> = {
  ...
  'attachment.uploadCardCoverTitle': '上傳卡面',
  'attachment.select': '選擇',
  'attachment.allFiles': '所有檔案',
  'attachment.cardCoverImages': '卡面圖片',
...
const ja: Record<MainMessageId, string> = {
  ...
  'attachment.uploadCardCoverTitle': 'カード券面をアップロード',
  'attachment.select': '選択',
  'attachment.allFiles': 'すべてのファイル',
  'attachment.cardCoverImages': 'カード券面画像',
